...
public final class Constants {
    ...
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = i2M(front_wheel_base); 
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = i2M(side_wheel_base); 
